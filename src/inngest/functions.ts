  ...
  async ({ event, step }) => {
    ...
    const previousMessages = await step.run(
      ...
      async () => {
        ...
        // This basically coherces the types for us, remove it if performance becomes an issue
    ...
    const agentState = createState<AgentState>(
      {
        summary: "",
        files: {},
      },
    ...
    const result = await network.run(event.data.value, { state: agentState });
    ...
    function generateFragmentTitle() {
